"""
Test Case: TC-L05
Name: Multiple attributes for same entity
Category: Entity Lookup
Input/Setup: Đức has email + phone + job...
Expected Result: Query thông tin Đức returns all 3 facts
"""
...
def run_test():
    ...
    print(f"Setting up entity facts for TC-L05...")
    ...
    # Expected: Query thông tin Đức returns all 3 facts

    for fact in entity_facts:
        print(f"  - {fact}")

    print("PASS: TC-L05 completed")


if __name__ == "__main__":
    run_test_wrapper("TC-L05", "Multiple attributes for same entity", run_test)
