...
"""
Test Case: TC-P02
Name: Entity lookup p99 < 5ms
Category: Performance & Latency
Input/Setup: entity_mentions with 1M rows; 500 concurrent exact lookups
Expected Result: p99 < 5ms; EXPLAIN shows index scan (not seq scan)
"""
